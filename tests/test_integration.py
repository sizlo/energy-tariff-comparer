# TODO: Rewrite these for the new world
...
# from octopus_parser import OctopusParserOLD
# from tarrif_parser import TariffParser
# from vaillant_parser import VaillantParserOLD
#
# TEST_DATA = os.path.join(os.path.dirname(os.path.realpath(__file__)), "data")
#
# heat_pump_consumption = VaillantParserOLD().parse(os.path.join(TEST_DATA, "vaillant", "bulk.csv"))
# total_consumption = OctopusParserOLD().parse(os.path.join(TEST_DATA, "octopus", "bulk.csv"))
